import { desSelectionSortMain } from "./desSelectionSort";

export const desSelectionSortUtil=(array,SPEED,arrayContainer)=>{
    
    const animations=desSelectionSortMain(array);
